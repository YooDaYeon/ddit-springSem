...
public class CustomDateEditorCS extends PropertyEditorSupport {
	private static final Logger logger = LoggerFactory.getLogger(CustomDateEditorCS.class);
	 ...
	 */
	public CustomDateEditorCS(DateFormat dateFormat, boolean allowEmpty) {
	 ...
	 */
	public CustomDateEditorCS(DateFormat dateFormat, boolean allowEmpty, int exactDateLength) {
		this.dateFormat = dateFormat;
		this.allowEmpty = allowEmpty;
